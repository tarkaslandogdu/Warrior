...
public class Sound
{
    ...
    public void SetSource(AudioSource source)
    {
        ...
        audioSource.clip = m_clips[randomClip];
    }
    ...
    public void Play()
    {
        ...
        audioSource.volume = volume * Random.Range(m_randomVolumeRange.x, m_randomVolumeRange.y);
        audioSource.pitch = pitch * Random.Range(m_randomPitchRange.x, m_randomPitchRange.y);
        audioSource.Play();
    }
}
